...
import { signUp, ActionResponse } from '@/lib/action/auth/auth'
...
export default function SignUpPage() {
    ...
    {/*To programmatically navigate between pages using methods like router.push(), router.replace(), and other client-side router navigation methods. */}
